...
_lr_productions = [
  ...
  ('program -> subprogram','program',1,'p_program_statement','parser5.py',9),
  ('subprogram -> statement ;','subprogram',2,'p_program_subprogram','parser5.py',13),
  ('subprogram -> statement ; subprogram','subprogram',3,'p_program_recursive','parser5.py',17),
  ('statement -> assignation','statement',1,'p_statement','parser5.py',21),
  ('statement -> assignation_shape','statement',1,'p_statement','parser5.py',22),
  ('statement -> assignation_color','statement',1,'p_statement','parser5.py',23),
  ('statement -> assignation_point','statement',1,'p_statement','parser5.py',24),
  ('statement -> assignation_size','statement',1,'p_statement','parser5.py',25),
  ('statement -> assignation_time','statement',1,'p_statement','parser5.py',26),
  ('statement -> structure','statement',1,'p_statement','parser5.py',27),
  ('statement -> shape','statement',1,'p_statement','parser5.py',28),
  ('statement -> animation','statement',1,'p_statement','parser5.py',29),
  ('statement -> PRINT expression','statement',2,'p_statement_print','parser5.py',33),
  ('structure -> FOR ( expression , expression , expression ) { subprogram }','structure',11,'p_structure','parser5.py',37),
  ('animation -> translation','animation',1,'p_animation','parser5.py',41),
  ('translation -> TRANSLATE ( animation_param , point_expression )','translation',6,'p_animation_translation','parser5.py',45),
  ('translation -> ROTATE ( animation_param , expression , AROUND ( point_expression ) )','translation',11,'p_animation_rotation','parser5.py',49),
  ('animation_param -> IDENTIFIER','animation_param',1,'p_animation_param_id','parser5.py',53),
  ('animation_param -> shape','animation_param',1,'p_animation_param_shape','parser5.py',57),
  ('shape -> circle_g','shape',1,'p_shape','parser5.py',61),
  ('shape -> rect_g','shape',1,'p_shape','parser5.py',62),
  ('shape -> polygon_g','shape',1,'p_shape','parser5.py',63),
  ('circle_g -> CIRCLE { point_expression , RADIUS ( expression ) , color_expression }','circle_g',11,'p_circle_g','parser5.py',67),
  ('rect_g -> RECT { point_expression , size_expression , color_expression }','rect_g',8,'p_rect_g','parser5.py',71),
  ('polygon_g -> POLYGON { point_expression , ( points_expression ) , color_expression }','polygon_g',10,'p_polygon_g','parser5.py',75),
  ('points_expression -> point_expression','points_expression',1,'p_expression_points','parser5.py',79),
  ('points_expression -> point_expression , points_expression','points_expression',3,'p_expression_points_recursive','parser5.py',83),
  ('point_expression -> POINT ( expression , expression )','point_expression',6,'p_expression_point','parser5.py',87),
  ('size_expression -> SIZE ( expression , expression )','size_expression',6,'p_expression_size','parser5.py',91),
  ('color_expression -> COLOR ( expression , expression , expression )','color_expression',8,'p_expression_color','parser5.py',95),
  ...
  ('expression -> NUMBER','expression',1,'p_expression_num_or_var','parser5.py',104),
  ('expression -> IDENTIFIER','expression',1,'p_expression_num_or_var','parser5.py',105),
  ('expression -> ( expression )','expression',3,'p_expression_paren','parser5.py',109),
  ('expression -> ADD_OP expression','expression',2,'p_minus','parser5.py',113),
  ('assignation_size -> IDENTIFIER = size_expression','assignation_size',3,'p_assign_size','parser5.py',117),
  ('assignation_point -> IDENTIFIER = point_expression','assignation_point',3,'p_assign_point','parser5.py',121),
  ('assignation_color -> IDENTIFIER = color_expression','assignation_color',3,'p_assign_color','parser5.py',125),
  ('assignation_shape -> IDENTIFIER = shape','assignation_shape',3,'p_assign_shape','parser5.py',129),
  ('assignation_time -> IDENTIFIER = TIME ( expression )','assignation_time',6,'p_assign_time','parser5.py',133),
  ('assignation -> IDENTIFIER = expression','assignation',3,'p_assign','parser5.py',137),
  ('expression -> RANDOM ( expression )','expression',4,'p_expression_random_max','parser5.py',148),
  ('expression -> RANDOM ( expression , expression )','expression',6,'p_expression_random_min_max','parser5.py',152),
]
